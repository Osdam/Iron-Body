        ...
        <tr>
            <td align="center" style="padding:32px 14px;">
                ...
                <table role="presentation" class="ib-container" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px; max-width:600px; background-color:#FFFFFF; border-radius:18px; overflow:hidden; box-shadow:0 18px 50px rgba(0,0,0,0.35);">
                    ...
                    {{-- ============ HEADER NEGRO + LOGO ============ --}}
                    <tr>
                        <td align="center" style="background-color:{{ $black }}; padding:38px 30px 30px 30px;">
                            @if(!empty($logoUrl))
                                <img src="{{ $logoUrl }}" alt="Iron Body Neiva" width="170" style="display:block; width:170px; max-width:70%; height:auto; margin:0 auto;">
                            @else
                    ...
                    <tr>
                        <td style="height:5px; background-color:{{ $gold }}; line-height:5px; font-size:0;">&nbsp;</td>
                    </tr>
